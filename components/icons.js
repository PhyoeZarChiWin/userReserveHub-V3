/* ReserveHub — inline SVG icon system (lucide-style, stroke-based, offline) */
(function (RH) {
  'use strict';
  ...
  var P = {
    ...
    'car': '<path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.2-.7-1.9-.7H5c-.6 0-1.1.4-1.4.9l-1.4 2.9A3.7 3.7 0 0 0 2 12v4c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/>',
    'snowflake': '<line x1="12" y1="2" x2="12" y2="22"/><line x1="3.3" y1="7" x2="20.7" y2="17"/><line x1="20.7" y1="7" x2="3.3" y2="17"/>',
    ...
    'sparkles': '<path d="M12 3l1.9 5.8a2 2 0 0 0 1.29 1.29L21 12l-5.81 1.91a2 2 0 0 0-1.29 1.29L12 21l-1.9-5.8a2 2 0 0 0-1.29-1.29L3 12l5.81-1.91a2 2 0 0 0 1.29-1.29L12 3z"/>',
    ...
    'qr-code': '<rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M21 14v4a3 3 0 0 1-3 3h-4"/><path d="M14 10h3v3"/><path d="M10 14h-3v3"/>',
   ...
   * @param {string} [cls]  extra classes ('icon' applied automatically)
   * @param {object} [opts] { filled:boolean }
   */
  RH.icon = function (name, cls, opts) {
    var path = P[name] || P['sparkles'];
    opts = opts || {};
    var klass = 'icon' + (cls ? ' ' + cls : '');
    return (
      '<svg class="' + klass + '" viewBox="0 0 24 24" fill="' + (opts.filled ? 'currentColor' : 'none') +
